    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <input type="text" name="id" placeholder="Type in an ID" onChange={handleChangeCourse}></input>
          <button onClick={handleSubmitDeleteCourse}>Delete by ID</button>
        </div>
        <div className="col-md-6">
          <h3>Find and Edit Class</h3>
          <input type="text" name="id" placeholder="Type in an ID" onChange={handleChangeClass}></input>
