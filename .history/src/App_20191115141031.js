...
const Readme = () => {
  return (
    <div className="col-md-8">
      ...
      <p>
        1. In the apiFacade change the URL to match your droplet URL. 2. To
        fetch data from the backend Rest-endpoint add new fetches to apiFacade.
        3. To use these new fetch methods just call them from App.js. 4. To
        deploy the SPA use - npm run build. n a terminal, in the root of your
        Client project, type npm run build. This will "build" your project into
        a folder build. 5. Still in the root of your project, type: surge
        --project ./build --domain A_DOMAIN_NAME.surge.sh 6. That’s it. Your SPA
        Client is now hosted like A_DOMAIN_NAME.surge.sh
      </p>
    </div>
  );
};
