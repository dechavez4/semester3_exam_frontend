    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <h4>add Course</h4>
            <input className="col-md-4" type="text" name="courseName" placeholder="Type a courseName"></input>
            <input className="col-md-4" type="text" name="description" placeholder="write a small description"></input>
            <button>Add</button>
        </div>
        <div className="col-md-6">
